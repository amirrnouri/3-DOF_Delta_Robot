...
if __name__ == "__main__":
    ...
    for z in arange(-0.14,-0.66,-0.01):

        for t in arange(0,2*math.pi,0.1):
            for rrange in arange(r, 0.072, -0.01):
                x=rrange*math.cos(t)
                y=rrange*math.sin(t)
    ...
    sio.savemat('body_nonoconst_shell_xwork.mat', {'body_nonoconst_shell_xwork':xwork})
    sio.savemat('body_nonoconst_shell_ywork.mat', {'body_nonoconst_shell_ywork':ywork})
    sio.savemat('body_nonoconst_shell_zwork.mat', {'body_nonoconst_shell_zwork':zwork})
...
# Top Surface:
    ...
    ywork = []
    zwork = []
    for rrange in arange(r, 0.01, -0.005):

        for t in arange(0,2*math.pi,0.1):
            for z in arange(-0.14, -0.66, -0.005):
    ...
    sio.savemat('top_nonoconst_shell_xwork.mat', {'top_nonoconst_shell_xwork': xwork})
    sio.savemat('top_nonoconst_shell_ywork.mat', {'top_nonoconst_shell_ywork': ywork})
    sio.savemat('top_nonoconst_shell_zwork.mat', {'top_nonoconst_shell_zwork': zwork})
